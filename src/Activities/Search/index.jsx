...
const Search = (props) => {
    ...
    const addSolution = (id, inputValue) => {
        ...
        if (id === "rus_lit" || id === "bel_lit") {
            const url = manifest[id].alt_url.replace("?", inputValue.replace(/ *\([^)]*\) */g, ""))
...
Search.propTypes = {
    setNotebooksOpen: PropTypes.func.isRequired,
