...
const WhatsNew = () => {
    const [visible, setVisible] = useState(() => localStorage.whats_closed_v !== '5')

    const handleClose = () => {
        setVisible(false)
        localStorage.whats_closed_v = '5'
    }
        ...
        visible && (
            <div className="WhatsNew">
                ...
                <ul className="change-log">
                    <li>🖼️ Теперь к урокам можно прикреплять фото</li>
                    <li>🤩 Аватарки в рейтинге (можно изменить в настройках)</li>
                    <li>😭 Якутов Роман удален с главного экрана</li>
                </ul>
