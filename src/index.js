...
import { database, remoteConfig, manifestContext, timetableContext } from './Context';
...
function App() {
    ...
    return (
        ...
        <div className="app center-auto active" data-scroll-lock-scrollable id="homescreen"><HomeScreen/></div>
        <div className="app center-auto" data-scroll-lock-scrollable id="week"><Week/></div>
        <div className="app center-auto" data-scroll-lock-scrollable id="marks"><Marks/></div>
