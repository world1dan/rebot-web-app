...
function SubjectRow(props) {
    ...
    function copy() {
        navigator.clipboard.writeText(hwInput.current.value)
        .then(() => {
        ...
        <div className={classes}>
            ...
            <div className="homework fr">
                <div className="scroll-wraper">
                    <input type="text" ref={hwInput} contentEditable="true"/>
                </div>
                <Dropdown>
            ...
            { !settings.stealth && props.lesson_data.hw && <div className="tool stealth" onClick={openInstant}><i className="fas fa-book"></i></div> }
        </div>
    );
